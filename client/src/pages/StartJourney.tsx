        ...
        {!isAuthenticated ? (
          <div className="text-center space-y-8">
            ...
            <div 
              ...
              style={{
                borderColor: 'hsl(158, 25%, 30%)',
                background: 'linear-gradient(135deg, hsl(32, 67%, 99%) 0%, hsl(32, 30%, 97%) 100%)',
              }}
            >
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="flex items-start gap-3 p-4 bg-white rounded-lg">
                    <CheckCircle className="h-6 w-6 text-dbb-forestGreen flex-shrink-0 mt-1" />
                    <div className="text-left">
                      <p className="font-semibold text-sm text-dbb-charcoal">Featured Placement</p>
                      <p className="text-xs text-dbb-charcoalSoft">Top visibility for your content</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-white rounded-lg">
                    <CheckCircle className="h-6 w-6 text-dbb-forestGreen flex-shrink-0 mt-1" />
                    <div className="text-left">
                      <p className="font-semibold text-sm text-dbb-charcoal">Exclusive Rewards</p>
                      <p className="text-xs text-dbb-charcoalSoft">Special perks and offers</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-white rounded-lg">
                    <CheckCircle className="h-6 w-6 text-dbb-forestGreen flex-shrink-0 mt-1" />
                    <div className="text-left">
                      <p className="font-semibold text-sm text-dbb-charcoal">Priority Access</p>
                      <p className="text-xs text-dbb-charcoalSoft">First to know about deals</p>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-sm text-dbb-charcoalSoft">
